...
from ground_station_core_kalman import GroundStation
...
PIXHAWK_PORTS = {
    1: "/dev/ttyUSB2",  # Drone 1 (ORIGIN referansı bu drone'dan alınır)
    2: "/dev/ttyUSB4",  # Drone 2
    3: "/dev/ttyUSB0",  # Drone 3
    4: "/dev/ttyUSB3",  # Drone 4
}
